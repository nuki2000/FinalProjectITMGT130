...
class CreateAccount5 extends StatefulWidget {
  const CreateAccount5({Key? key}) : super(key: key);
...
class _CreateAccount5State extends State<CreateAccount5> {
  ...
  submit() {
    ...
    if (form!.validate()) {
      form.save();
      SnackBar snackbar = SnackBar(content: Text("Welcome $genderpref!"));
      _scaffoldMessengerKey.currentState?.showSnackBar(snackbar);
      Timer(const Duration(seconds: 0), () {
        Navigator.pop(context, genderpref);
      });
    }
  }
                        ...
                        Padding(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (val) => genderpref = val.toString(),
