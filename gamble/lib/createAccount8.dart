...
class CreateAccount8 extends StatefulWidget {
  const CreateAccount8({Key? key}) : super(key: key);
...
class _CreateAccount8State extends State<CreateAccount8> {
  ...
  submit() {
    ...
    if (form!.validate()) {
      form.save();
      SnackBar snackbar = SnackBar(content: Text("Welcome $gamertype!"));
      _scaffoldMessengerKey.currentState?.showSnackBar(snackbar);
      Timer(const Duration(seconds: 0), () {
        Navigator.pop(context, gamertype);
      });
    }
  }
                        ...
                        Padding(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (val) => gamertype = val.toString(),
                              decoration: InputDecoration(
                                labelText: "Gamer Type",
                                ...
                                hintText: "Pro/Casual/Competitive",
                              ),
                            ),
                          ),
                        ),
