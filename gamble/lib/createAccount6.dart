...
class CreateAccount6 extends StatefulWidget {
  const CreateAccount6({Key? key}) : super(key: key);
...
class _CreateAccount6State extends State<CreateAccount6> {
  ...
  submit() {
    ...
    if (form!.validate()) {
      form.save();
      SnackBar snackbar = SnackBar(content: Text("Welcome $gameplay!"));
                        ...
                        Padding(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              onSaved: (val) => gameplay = val.toString(),
                              decoration: InputDecoration(
                                ...
                                hintText: "Enter your preferred gameplay",
                              ),
                            ),
                          ),
                        ),
